      ...
      module SystemV
        module CST6CDT
          ...
          timezone 'SystemV/CST6CDT' do |tz|
            ...
            tz.transition 2067, 4, :o1, 3070857600, 14856779, 6
            tz.transition 2067, 10, :o0, 3087183600, 59431651, 24
            tz.transition 2068, 4, :o1, 3102912000, 14859005, 6
            tz.transition 2068, 10, :o0, 3118633200, 59440387, 24
          end
        end
      end
    end
